...
test_expect_success "check syntax of po/TEAMS" '
	...
	cat >expect <<-EOF &&
	ERROR: bad syntax at po/TEAMS:79 (unknown key "Respository"): Respository:    https://github.com/l10n-tw/git-po
	ERROR: bad syntax at po/TEAMS:80 (need two tabs between k/v): Leader:     Yi-Jyun Pan <pan93412 AT gmail.com>
